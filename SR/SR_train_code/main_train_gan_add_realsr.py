...
def main(json_path='options/train_bsrgan_x4_gan_realsr_mutil.json'):
    ...
    util.mkdir(os.path.join(opt['path']['log'],"tb_logger"))
    train_info = SummaryWriter(log_dir=(os.path.join(opt['path']['log'],"tb_logger")))
    # ----------------------------------------
    # seed
    # ----------------------------------------
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_print'] == 0 and opt['rank'] == 0:
                ...
                for k, v in logs.items():  # merge log information into message
                    ...
                    train_info.add_scalar(k, v, current_step)
                logger.info(message)
            # logger 在此处保存 tcd
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                train_info.add_scalar("psnr", avg_psnr, current_step)
                # testing log
