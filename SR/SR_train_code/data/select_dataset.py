...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['blindsr_add_realsr']:
        from data.dataset_blindsr_add_realsr import DatasetBlindSR_add_RealSR as D

    elif dataset_type in ['blindsr_add_realsr_mutil']:
        from data.dataset_blindsr_add_realsr_mutil import DatasetBlindSR_add_RealSR_mutil as D
