...
#        time.sleep(1)
    ...
    def __getitem__(self, index):
        ...
        util.imsave(util.single2uint(img_L), os.path.join(self.opt['data_temp'],img_name+"LR.png"))
        util.imsave(util.single2uint(img_H),  os.path.join(self.opt['data_temp'],img_name+"HR.png"))
        # ------------------------------------
